						...
						<div class="card">
							<div class="card-body">
								...
								<p class="card-description"> 
									<?php if(isset($_GET["page_data"])){echo "<span class='text-info'>".$_GET["page_data"]."</span>";}else{ echo "Create Office Cost";} ?>
								</p>
								<form action="controller/logic.php" method="POST" class="forms-sample">
									<div class="form-group row">
										...
										<div class="col-sm-9">
										<input type="text" name="office_details" class="form-control" id="exampleInputUsername2" placeholder="Details" required>
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
										<input type="test" name="office_amount" class="form-control" id="exampleInputEmail2" placeholder="Amount" required>
										</div>
									</div>
									<div class="form-group row">
										<label for="exampleInputEmail2" class="col-sm-3 col-form-label">Date</label>
										<div class="col-sm-9">
										<input type="date" name="office_date" class="form-control" id="exampleInputEmail2" placeholder="Date" required>
										</div>
									</div>
									<button type="submit" name="office_submit" class="btn btn-primary me-2">Submit</button>
								</form>
							</div>
						</div>
					</div>
